...
//
// Durante la migrazione a ondate `electron/` contiene un mix di .js e .ts:
// includiamo entrambi così `dist-electron/` è sempre eseguibile.
//
// Uso:
//   node build/esbuild-electron.mjs           build una tantum
//   node build/esbuild-electron.mjs --watch   ricostruisce a ogni modifica
