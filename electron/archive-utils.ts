...
function runTar(args: string[]): Promise<TarResult> {
...
async function assertSafeArchive(archive: string): Promise<void> {
...
async function extractArchive(
  archive: string,
  destDir: string,
  { stripComponents = 0 }: { stripComponents?: number } = {},
): Promise<void> {
...
export { readFeedUrl, assertSafeArchive, extractArchive };
