...
function ff(args: string[]): Promise<{ stdout: Buffer; stderr: Buffer }> {
...
async function signature(png: string): Promise<Buffer> {
...
async function run(): Promise<void> {
  ...
  const probe = (await pg.evaluate(JS_JACKED)) as JackedProbe;
