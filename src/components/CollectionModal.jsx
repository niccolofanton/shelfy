...
export default function CollectionModal({ initial, onClose, onSave, onDelete, collections = [] }) {
  ...
  const [deleteMode, setDeleteMode] = useState('label');
  ...
  const isPlatform = !!(initial?.platform || initial?.external_id);
