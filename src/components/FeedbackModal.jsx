...
const estimateB64 = (bytes) => Math.ceil(bytes / 3) * 4;
...
export default function FeedbackModal({ onClose }) {
  ...
  const pendingRef = useRef({ count: 0, b64: 0 });
  ...
  const composeAttachWarn = ({ tooBigName, tooMany, tooHeavy }) => {
    const lines = [];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div inert={overlayActive ? '' : undefined} className="px-5 py-5 space-y-4">
