...
export class DictationRecorder {
  ...
  _onSamples(samples) {
    ...
    while (this._total > MAX_SAMPLES && this._chunks.length > 1) {
      this._total -= this._chunks.shift().length;
    }
  }

  get level() { return this._level; }
  get durationSec() { return this._total / SAMPLE_RATE; }
  get hasAudio() { return this._total > 0; }
  ...
  stop() {
    try { this._node && (this._node.port.onmessage = null); } catch {}
